...
(function($,window){
	...
	*/
	 ...
	 */
	_1p21.fw.slideDown = function(elem) {
	 ...
	 */
	_1p21.fw.slideUp = function(elem) {
			...
			$(selector).find('.input-trumbowyg:not(.input-trumbowyg-custom)').each(function(){
				...
				if(!($(this).closest('.modal').length > 0)) { //catch dynamo trumbobois
					...
					if(!$('#trumbowyg-icons').length){
						$(document.body).prepend('<div id="trumbowyg-icons">'+_1p21.fw.trumbowyg.iconsMarkup+'</div>');
					}
				...
				if(
					...
					if(
						...
						if(selector.closest('.accordion-group:not(.accordion-group-multiple)').length) {
							...
							selector.closest('.accordion-group:not(.accordion-group-multiple)').find('.accordion')._1p21.fw.slideUp(); 
