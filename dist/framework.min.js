...
(function($,window){
	...
	*/
	 ...
	 */
	frameWork.slideDown = function(elem) {
	...
	frameWork.getAncestors = function (elem,selector) {
	...
	frameWork.docReady(function(){
		...
		frameWork.addEvent(document.body,'focus','input[data-toggle="dropdown"]',function(e){

			var selector =  _.getTheToggled(e.target,'dropdown');

			if( selector ){
				frameWork.setDropdown(selector,e.target,'open');
			}
		...
		frameWork.addEvent(document.body,'blur','input[data-toggle="dropdown"]',function(e){
			...
			setTimeout(function(){
				...
				if( selector ){
					frameWork.setDropdown(selector,e.target,'close');
				}
			},200);
			...
			var clicked = e.target,
				...
				if( selector ){
					...
					if(
						...
						if (selectorAncestor){
							var selectorUncles = frameWork.getSiblings(selectorAncestor)
		...
		//tooltip
		frameWork.addEvent(document.body,'click','*[data-toggle="tooltip-click"]',function(e){
			e.preventDefault();
